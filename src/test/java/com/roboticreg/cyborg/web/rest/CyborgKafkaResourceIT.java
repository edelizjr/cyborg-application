...
import com.roboticreg.cyborg.config.EmbeddedKafka;
import com.roboticreg.cyborg.config.KafkaSseConsumer;
import com.roboticreg.cyborg.config.KafkaSseProducer;
...
class CyborgKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/cyborg-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
